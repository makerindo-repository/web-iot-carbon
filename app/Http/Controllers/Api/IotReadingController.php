...
class IotReadingController extends Controller
{
    ...
    public function storeReading(Request $request)
    {
        ...
        $reading = IotReading::create([
            ...
            'latitude' => $request->input('location.latitude') ?? 0,
            'longitude' => $request->input('location.longitude') ?? 0,
            'altitude_m' => $request->input('location.altitude_m', 0),
            'co2_sensor' => $request->input('carbon_data.co2_ppm') ?? 0,
            ...
            'wind_speed_kmh' => $request->input('environment.wind_speed_kmh_kmh', $request->input('environment.wind_speed_kmh')) ?? 0,

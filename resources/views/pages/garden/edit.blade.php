                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="garden_code" class="block mt-1 w-full rounded-xl" type="text"
                                    name="garden_code" :value="old('garden_code', $garden->garden_code)" required autofocus />
                            ...
                            <div class="w-full md:col-span-2 mt-4">
                                <x-input-label>{{ __('Ubah Area Kebun di Peta (Wajib)') }}</x-input-label>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                const drawControl = new L.Control.Draw({
                    ...
                    draw: {
                        polygon: { allowIntersection: false, showArea: true, icon: standardIcon, shapeOptions: { color: '#0f8dedff' } },
                ...
                map.on(L.Draw.Event.CREATED, function (e) {
                    ...
                    if (latlngs.length < 4) {
                        alert("Peringatan: Area Kebun harus mempunyai minimal 4 titik sudut!");
                        return;
                    }
                ...
                map.on(L.Draw.Event.EDITED, function (e) {
                    e.layers.eachLayer(function (layer) {
                        ...
                        latInput.value = center.lat.toFixed(7);
                        lngInput.value = center.lng.toFixed(7);
                        areaInput.value = (L.GeometryUtil.geodesicArea(layer.getLatLngs()[0]) / 10000).toFixed(3);
                    });
                });

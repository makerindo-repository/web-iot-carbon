    ...
    <x-slot name="header">
        <h2 class="leading-tight">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item breadcrumb-active">{{ __('Tambah Data Media ') }}</li>
            </ol>
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-4">
                <div class="p-6">
                    <h1 class="text-3xl font-extrabold mb-4">Tambah Data Media</h1>
                            ...
                            <template id="template-plants">
                                <div>
                                    ...
                                    <x-text-input id="plants" class="block mt-1 w-full rounded-xl" type="text"
                                        name="plants[]" :value="old('plants')" required autofocus autocomplete="plants" />

    ...
    <x-slot name="header">
        <h2 class="leading-tight">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item breadcrumb-active">{{ __('Daftar Paket Langganan') }}</li>
            </ol>
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg px-4">
                <div class="flex flex-col sm:flex-row sm:justify-between my-5 items-center">
                    <h1 class="text-3xl font-extrabold text-start">Tabel Daftar Paket Langganan</h1>
                ...
                <div class="overflow-x-scroll">
                    <table class="w-full align-middle border-slate-400 table mb-0 mt-3" id="plan-table">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama Paket</th>
                                ...
                                <tr>
                                    ...
                                    <td class="flex space-x-2 items-center">
                                        ...
                                        <form action="{{ route('subscription.plan.destroy', $plan->id) }}" method="POST"
                                            class="delete-form" data-series="{{ $plan->name }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit">
        ...
        <script>
            ...
            $(document).ready(function() {
                $('#plan-table').DataTable({
                    ...
                    buttons: [{
                            extend: 'csv',
                            text: 'Export CSV',
                            title: 'Dafar Paket Langganan',
                            className: 'bg-yellow-500 text-white px-3 py-1 rounded hover:bg-yellow-600',
                            filename: function() {
                                return `daftar_paket_langganan_${timestamp()}`;
                            },
                            exportOptions: {
                                columns: [0, 1, 2, 3]
                            }
                    ...
                    language: {
                        ...
                        emptyTable: "Tidak ada data paket langganan yang tersedia",
                        info: "Menampilkan _START_ hingga _END_ dari _TOTAL_ entri",
                        infoEmpty: "Tidak ada data langganan yang dapat ditampilkan.",
                        zeroRecords: "Data paket langganan tidak ditemukan.",
            ...
            document.querySelectorAll('.delete-form').forEach(form => {
                form.addEventListener('submit', function(event) {
                    ...
                    const planName = this.getAttribute('data-series');
                    Swal.fire({
                        title: 'Konfirmasi',
                        text: `Apakah Anda yakin ingin menghapus paket ${planName}?`,
                        icon: 'warning',

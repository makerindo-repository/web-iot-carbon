                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="plot_code" class="block mt-1 w-full rounded-xl" type="text"
                                    name="plot_code" :value="old('plot_code', $landPlot->plot_code)" required autofocus />
                            ...
                            <div class="w-full md:col-span-2 mt-4">
                                <x-input-label>{{ __('Ubah Area Lahan di Peta (Wajib)') }}</x-input-label>
                                <div id="map" class="mt-2 rounded-xl border border-gray-300"></div>
                                <p class="text-xs text-red-500 mt-1">*Jika Anda menghapus area polygon (ikon tempat sampah), Anda harus menggambar area baru untuk dapat menyimpannya.</p>
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="latitude" class="block mt-1 w-full rounded-xl bg-gray-100" type="number" step="any"
                                    name="latitude" :value="old('latitude', $landPlot->latitude)" readonly required />
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="longitude" class="block mt-1 w-full rounded-xl bg-gray-100" type="number" step="any"
                                    name="longitude" :value="old('longitude', $landPlot->longitude)" readonly required />
        ...
        <script>
            document.addEventListener("DOMContentLoaded", () => {
                ...
                if (existingData && existingData !== 'null' && existingData.trim() !== '') {
                    ...
                    // Fallback: zoom ke coordinate terakhir bila tidak ketemu polygon
                ...
                // 6. Membersihkan jika Gambar Area dihapus pakai menu Tongsampah (Remove)
